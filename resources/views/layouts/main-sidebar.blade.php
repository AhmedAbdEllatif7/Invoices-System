            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('Images/317691123_1910822605946650_4850342044776345663_n.jpg') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg>&nbsp;&nbsp;<span class="side-menu__label">الرائيسية</span></a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg>&nbsp;&nbsp;<span class="side-menu__label">الفواتير</span><i
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg>&nbsp;&nbsp;<span class="side-menu__label">المستخدمين</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('users/' . ($page = 'show_users')) }}">قائمة المستخدمين</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg>&nbsp;&nbsp; <span class="side-menu__label"> الأعدادات</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
